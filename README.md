...
内置 6 个预设模板供参考，也可以从空白开始做自己的。标题字体除了常规中文字体（宋体、黑体、楷体、手书），还内置了米哈游游戏的架空文字（提瓦特文、稻妻文、须弥文、坎瑞亚文、层岩巨渊坎瑞亚文、赤冠文、星穹铁道文、罗浮文、绝区零系统文、绝区零甲文），来自 [HoYo-Glyphs](https://github.com/SpeedyOrc-C/HoYo-Glyphs) 项目，感谢 @SpeedyOrc-C 的制作与开源；以及《明日方舟：终末地》的终末地文，来自 [Endfield_Font](https://github.com/lhclbt/Endfield_Font) 项目，感谢 @lhclbt 的制作与开源。
